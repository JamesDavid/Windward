...
const CONFIG = Object.freeze({
  ...
  AI: {
    ...
    LADDER: [
      { name: 'CALM', overrides: { DECISION_INTERVAL: 2.93, PLACE_INTERVAL: 1.98, GARRISON_DRUMS: 3, GARRISON_LANCES: 3, GUN_CADENCE: 43.4, GUN_NEAR: 12.3, MAST_INTERVAL: 31.3, TOWARD_PLAYER_BIAS: 0.24, ORE_BIAS: 1.11, WAVE_STRENGTH_MULT: 0.93, WAVE_INTERVAL_MULT: 0.96 } },
      { name: 'STERN', overrides: { DECISION_INTERVAL: 4.0, PLACE_INTERVAL: 2.01, GARRISON_DRUMS: 4, GARRISON_LANCES: 2, GUN_CADENCE: 41.0, GUN_NEAR: 8, MAST_INTERVAL: 35.8, TOWARD_PLAYER_BIAS: 0.35, ORE_BIAS: 0.53, WAVE_STRENGTH_MULT: 0.97, WAVE_INTERVAL_MULT: 0.89 } },
      { name: 'ANGRY', overrides: { DECISION_INTERVAL: 3.43, PLACE_INTERVAL: 2.1, GARRISON_DRUMS: 3, GARRISON_LANCES: 2, GUN_CADENCE: 41.0, GUN_NEAR: 8, MAST_INTERVAL: 22.1, TOWARD_PLAYER_BIAS: 0.34, ORE_BIAS: 0.91, WAVE_STRENGTH_MULT: 0.75, WAVE_INTERVAL_MULT: 0.85 } },
      { name: 'ENRAGED', overrides: { DECISION_INTERVAL: 3.43, PLACE_INTERVAL: 2.1, GARRISON_DRUMS: 3, GARRISON_LANCES: 2, GUN_CADENCE: 41.0, GUN_NEAR: 12.5, MAST_INTERVAL: 22.1, TOWARD_PLAYER_BIAS: 0.34, ORE_BIAS: 1.05, WAVE_STRENGTH_MULT: 0.91, WAVE_INTERVAL_MULT: 0.85 } }
    ],
