...
| 8 | Great Temple HP bars + edge threat warning; influence lifts the shroud (player couldn't build into fog they were entitled to build in); Wave 5 signature sequence verified end-to-end by test; fillers get standard plots | *(this commit)* | feat: temple bars, influence-lit shroud, wave-5 gate test |
